...
export default function ProviderProfileComplete(props) {
    const { apiUrl, enableDemoMode, primaryColor } = props
        ...
        if (targetId) {
            try {
                ...
                const response = await fetch(
                    `${apiUrl}/directorio/proveedor/${targetId}`,
                    { headers }
                )
                ...
                if (response.ok) {
                    ...
                    const mapped = {
                        ...
                        email:
                            res.email ||
                            (user && user.id === targetId ? user.email : ""),
            ...
            <div style={fS.errorContainer}>
                ...
                <button
                    ...
                    (window.location.href =
                        "https://overly-mindset-259417.framer.app/login")
                    }
                    style={{
                        ...fS.mainBtn,
                ...
                <div style={fS.content}>
                    <div style={hS.flex}>
                        <div style={hS.left}>
                            ...
                            <div style={hS.info}>
                                ...
                                <p style={{ ...hS.cat, color: primaryColor }}>
                                    {data.category}
                                </p>
                            </div>
                        </div>
                    ...
                    <div style={hS.bioSection}>
                        ...
                        {isEditing ? (
                            ...
                            <p style={hS.bioText}>
                                {data.description ||
                                    "Sin descripción profesional cargada."}
                            </p>
                        )}
                    </div>
                </div>
                        ...
                        <section style={fS.section}>
                            ...
                            {data.portfolio.length === 0 ? (
                                <div style={fS.empty}>
                                    ...
                                    />
                                    <p>
                                        No hay trabajos cargados en el portfolio
                                        aún.
                                    </p>
                                </div>
                            ) : (
