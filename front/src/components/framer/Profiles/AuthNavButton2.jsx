...
export default function AuthNavButton(props) {
    ...
    const currentName =
        contextoActivo.tipo === "USUARIO_BASE"
            ? cuentaBase.nombre
            : contextoActivo.nombreContexto

    const currentIcon =
        contextoActivo.tipo === "EMPRESA" ? (
            <Building size={16} />
        ) : contextoActivo.tipo === "PROVEEDOR" ? (
            <Briefcase size={16} />
        ) : (
            <User size={16} />
        )
            ...
            >
                <div
                    style={{
                        ...
                        backgroundImage: contextoActivo.fotoUrl
                            ? `url(${contextoActivo.fotoUrl})`
                            : "none",
